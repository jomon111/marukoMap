        ...
        t = l.Marker.extend({
            ...
            _getIconSVG(t, i) {
                ...
                return {
                    ...
                    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${t}" version="1.1" viewBox="-${o} -${o} ${t} ${t}">` + '<circle r="' + s + '" style="' + i + '" /></svg>',
                    w: t,
                    h: t
                }
            },
        ...
        e = l.Control.extend({
            ...
            _onClick() {
                ...
                if (this._userPanned = !1, this._userZoomed = !1, this._active && !this._event) this.stop();
                    ...
                    let t = s.outOfView;
                    switch (this._map.getBounds().contains(this._event.latlng) && (t = i ? s.inView : s.inViewNotFollowing), s[t] && (t = s[t]), t) {
                        case "setView":
                            this.setView();
                            break;
                        case "stop":
